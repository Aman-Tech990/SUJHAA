...
const Login = () => {
  ...
  const [loadingBtn, setLoadingBtn] = useState(false); // ⭐ BUTTON LOADER STATE

  const handleSubmit = async (e) => {
    e.preventDefault();

    setLoadingBtn(true); // show loader
      ...
      if (res.data.success) {
        ...
        switch (res.data.role) {
          ...
          case "FIELD_OFFICER":
            ...
            break;
          case "CENTRAL_ADMIN":
            window.location.href = "/centralOfficer/dashboard";
            break;
          case "TRAINER":
    ...
    setLoadingBtn(false); // hide loader after response
          ...
          <div className="max-w-md mx-auto w-full">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-700 my-4">Digital ID</label>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-12 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent bg-gray-50 hover:bg-white transition-all"
              ...
              <button
                type="submit"
                disabled={loadingBtn}
                className={`cursor-pointer w-full bg-green-700 hover:bg-green-800 text-white font-bold py-3 px-4 rounded-xl transition-all duration-200 flex items-center justify-center gap-2 shadow-lg shadow-green-700/30
                ${loadingBtn ? "opacity-80 cursor-not-allowed" : "hover:shadow-green-700/40 hover:-translate-y-0.5"}`}
              >
                {loadingBtn ? (
                  <>
