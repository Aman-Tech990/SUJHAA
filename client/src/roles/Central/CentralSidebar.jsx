...
const CentralSidebar = ({ onLinkClick }) => {
  const navItems = [
    ...
    { name: "State Applications", path: "/centralOfficer/beneficiaryApplications", icon: Folder },
  ];

  return (
    // FIX 1: changed 'min-h-screen' to 'h-full'
    // FIX 2: changed 'w-72' to 'w-full' (parent <aside> controls the width)
    <div className="flex flex-col gap-2 p-4 bg-[#ffc72c] h-full w-full">
