...
// IMPORTANT: Importing State-specific versions
...
const StateLayout = () => {
  ...
  useEffect(() => {
    // Scroll to top of main content whenever route changes
  ...
  return (
    ...
    <div className="flex h-screen flex-col bg-gray-50">
      ...
      <StateNavbar onMenuClick={() => setIsMobileSidebarOpen(!isMobileSidebarOpen)} />
          ...
          <div className="fixed inset-0 z-50 flex md:hidden">
            ...
            <div className="relative flex w-64 flex-col bg-white shadow-xl">
              ...
              <div className="flex items-center justify-between border-b p-4">
                 <span className="font-bold text-lg text-gray-800">State Menu</span>
                 <button 
                   onClick={() => setIsMobileSidebarOpen(false)}
              ...
              <div className="flex-1 overflow-y-auto">
                {/* Pass onLinkClick so the sidebar closes when a mobile user clicks a link */}
                <StateSidebar onLinkClick={() => setIsMobileSidebarOpen(false)} />
              </div>
            </div>
          </div>
        )}
